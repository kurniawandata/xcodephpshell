...
Informasi Sistem:
    ...
    ✅ User - User yang menjalankan PHP
    ✅ PHP Version - Versi PHP yang digunakan
    ✅ Server - Software server (Apache/Nginx)
    ✅ IP Address - Alamat IP server
Fitur Navigasi:
    ✅ Feature Cards - 3 tombol pintas ke Shell, Files, Reverse
    ✅ Logo X-Code - Link ke xcode.or.id
    ✅ Footer - Informasi lisensi GPL v2
💻 2. SHELL (Command Execution)
Fitur Utama:
    ✅ Execute Command - Jalankan perintah sistem apapun
    ✅ Interactive Terminal - Tampilan seperti terminal asli
    ✅ User & Directory Info - Menampilkan user dan direktori aktif
Quick Commands (Tombol Pintas):
    ✅ ls -la - List file dengan detail
    ✅ pwd - Print working directory
    ✅ whoami - Menampilkan user saat ini
    ✅ id - Menampilkan user ID dan group
    ✅ uname -a - Informasi sistem kernel
    ✅ php -v - Versi PHP
Tampilan:
    ✅ Terminal dengan warna hijau (seperti terminal asli)
    ✅ Prompt $ untuk command
    ✅ Output dengan format pre (monospace)

📁 3. FILES (File Manager)
Fitur Manajemen File:
    ✅ Browse Directory - Navigasi folder
    ✅ Upload File - Upload file ke server
    ✅ Download File - Download file dari server
    ✅ Delete File - Hapus file (dengan konfirmasi)
    ✅ Edit File - Edit file langsung di browser
    ✅ Save File - Simpan perubahan file
Navigasi:
    ✅ Root - Ke direktori root /
    ✅ Refresh - Refresh halaman
    ✅ Parent - Ke direktori di atasnya
Informasi File:
    ✅ Nama file
    ✅ Ukuran file (dalam KB/MB/GB)
    ✅ Permission (755, 644, dll)
    ✅ Tanggal modifikasi
    ✅ Icon folder/file (berbeda warna)
...
Informasi yang Ditampilkan:
    ...
    ✅ URL untuk menjalankan reverse shell
...
🔒 6. KEAMANAN & LISENSI
    ✅ GNU GPL v2 - Lisensi open source
    ✅ Legal Use Only - Peringatan untuk penggunaan legal
    ✅ Validasi Input - Proteksi basic
    ✅ Error Handling - Menampilkan error dengan baik
...
Mobile (480px):
    ✅ Menu dengan icon saja (tanpa teks)
    ✅ Tombol lebih kecil
    ✅ Form dalam 1 kolom

🛠️ 8. FITUR TEKNIS
    ✅ PHP Native - Tidak perlu framework
    ✅ Single File - Semua dalam 1 file
    ✅ No Database - Tidak perlu database
    ✅ Cross-Platform - Bisa di Linux/Windows
    ✅ Lightweight - Ukuran kecil, cepat loading

📝 9. INFORMASI TAMBAHAN
    ✅ Versi - X-Shell Pro v2.0
    ✅ Developer - Kurniawan X-code
    ✅ Repository - https://github.com/kurniawandata/xcodephpshell
    ✅ Website - https://xcode.or.id
